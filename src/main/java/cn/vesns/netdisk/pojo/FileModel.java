...
import cn.vesns.netdisk.helper.DocumentManager;
import cn.vesns.netdisk.helper.FileUtility;
import cn.vesns.netdisk.helper.ServiceConverter;
...
//        document.urlUser = DocumentManager.GetFileUri(fileName, false);
        document.fileType = Objects.requireNonNull(FileUtility.GetFileExtension(fileName)).replace(".", "");
